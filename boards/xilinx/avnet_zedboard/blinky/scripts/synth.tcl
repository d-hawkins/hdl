...
#
# Avnet Zedboard 'blinky' Vivado synthesis script.
#
# Script execution;
#
# 1. Start Vivado
...
#    the Zedboard using the default Zedboard BDF file installed
#    with Vivado. The Avnet github BDF repo may have an updated
#    version.
#
#    Avnet Github repo:
...
#
#    This script does not require the Zedboard board file to run.
...
#  * hdl/boards/xilinx/avnet_zedboard/blinky/
#
...
set board       $hdl/boards/xilinx/avnet_zedboard
...
set project(part) xc7z020clg484-1
...
#
# Library components
lappend filenames $lib/zynq7/src/zynq7_fclk_clks_and_resets.sv
#
# Top-level design
lappend filenames $src/zedboard.sv
...
# Pin constraints
set     filenames {}
lappend filenames $constraints/zedboard_pin_constraints.tcl
lappend filenames $constraints/zedboard_timing_constraints.tcl
