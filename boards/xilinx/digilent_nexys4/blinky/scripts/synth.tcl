...
#
# Digilent Nexys-4 'blinky' Vivado synthesis script.
#
# Script execution;
#
# 1. Start Vivado
...
#  * hdl/boards/xilinx/digilent_nexys4/blinky/
#
...
set board       $hdl/boards/xilinx/digilent_nexys4
...
set project(part) xc7a100tcsg324-1
...
#
# Library components
lappend filenames $lib/hex_display/src/hex_display.vhd
lappend filenames $lib/hex_display/src/hex_display_mux.vhd
#
# Top-level design
lappend filenames $src/nexys4.vhd
...
# Pin constraints
set     filenames {}
lappend filenames $constraints/nexys4_pin_constraints.tcl
lappend filenames $constraints/nexys4_timing_constraints.tcl
lappend filenames $constraints/nexys4_device_constraints.tcl
