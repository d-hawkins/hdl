...
#
# Digilent Basys-3 'blinky' Vivado synthesis script.
#
# Script execution;
#
# 1. Start Vivado
...
#  * hdl/boards/xilinx/digilent_basys3/blinky/
#
...
set board       $hdl/boards/xilinx/digilent_basys3
...
set project(part) xc7a35tcpg236-1
...
#
# Top-level design
lappend filenames $src/basys3.vhd
...
# Pin constraints
set     filenames {}
lappend filenames $constraints/basys3_pin_constraints.tcl
lappend filenames $constraints/basys3_timing_constraints.tcl
lappend filenames $constraints/basys3_device_constraints.tcl
